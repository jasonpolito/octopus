...
/***/ "../../Sites/octopus/src/js/app.js":
/*!******************************************************!*\
  !*** /Users/jasonpolito/Sites/octopus/src/js/app.js ***!
  \******************************************************/
/*! no exports provided */
...
/* harmony import */ var pace_js_amd_fix__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! pace-js-amd-fix */ "./node_modules/pace-js-amd-fix/pace.js");
/* harmony import */ var pace_js_amd_fix__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(pace_js_amd_fix__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _Users_jasonpolito_Sites_octopus_src_js_utils_SetupPage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! /Users/jasonpolito/Sites/octopus/src/js/utils/SetupPage */ "../../Sites/octopus/src/js/utils/SetupPage.js");
/* harmony import */ var barba_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! barba.js */ "./node_modules/barba.js/dist/barba.js");
/* harmony import */ var barba_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(barba_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _Users_jasonpolito_Development_build_tailwind_config__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tailwind-config */ "./tailwind-config.js");
/* harmony import */ var _Users_jasonpolito_Development_build_tailwind_config__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_Users_jasonpolito_Development_build_tailwind_config__WEBPACK_IMPORTED_MODULE_5__);
...
var font = document.querySelector("[data-font-family]");
...
var sizes = {};
var screenKeys = Object.keys(_Users_jasonpolito_Development_build_tailwind_config__WEBPACK_IMPORTED_MODULE_5__["screens"]);
var keyLength = screenKeys.length;

for (var screen in _Users_jasonpolito_Development_build_tailwind_config__WEBPACK_IMPORTED_MODULE_5__["screens"]) {
  var width = _Users_jasonpolito_Development_build_tailwind_config__WEBPACK_IMPORTED_MODULE_5__["screens"][screen];
  var index = screenKeys.indexOf(screen);
  var nextWidth = index == keyLength - 1 ? false : _Users_jasonpolito_Development_build_tailwind_config__WEBPACK_IMPORTED_MODULE_5__["screens"][screenKeys[index + 1]];
  sizes["--".concat(screen)] = "(min-width: ".concat(width, ")").concat(nextWidth ? "and (max-width: " + nextWidth + ")" : "", ")");
}
...
Object(_Users_jasonpolito_Sites_octopus_src_js_utils_SetupPage__WEBPACK_IMPORTED_MODULE_3__["SetupPage"])();
var HideShowTransition = barba_js__WEBPACK_IMPORTED_MODULE_4___default.a.BaseTransition.extend({
...
barba_js__WEBPACK_IMPORTED_MODULE_4___default.a.Pjax.getTransition = function () {
  return HideShowTransition;
};

barba_js__WEBPACK_IMPORTED_MODULE_4___default.a.Pjax.start();
...
barba_js__WEBPACK_IMPORTED_MODULE_4___default.a.Dispatcher.on("transitionCompleted", function (currentStatus, oldStatus, container) {
  ...
  Object(_Users_jasonpolito_Sites_octopus_src_js_utils_SetupPage__WEBPACK_IMPORTED_MODULE_3__["SetupPage"])(currentStatus.url);
});

/***/ }),

/***/ "../../Sites/octopus/src/js/utils.js":
/*!********************************************************!*\
  !*** /Users/jasonpolito/Sites/octopus/src/js/utils.js ***!
  \********************************************************/
/*! exports provided: responsifyImages, generateIcons, attachDismissableBanners, dismissBanner, assignActiveLinks, attachSmoothScroll, lazyLoadImages */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "responsifyImages", function() { return responsifyImages; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateIcons", function() { return generateIcons; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "attachDismissableBanners", function() { return attachDismissableBanners; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dismissBanner", function() { return dismissBanner; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "assignActiveLinks", function() { return assignActiveLinks; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "attachSmoothScroll", function() { return attachSmoothScroll; });
...
/* harmony import */ var _utils_responsify__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/responsify */ "../../Sites/octopus/src/js/utils/responsify.js");



var responsifyImages = function responsifyImages(imgs) {
  return Object(_utils_responsify__WEBPACK_IMPORTED_MODULE_2__["responsify"])(imgs);
};
var generateIcons = function generateIcons() {
  feather_icons__WEBPACK_IMPORTED_MODULE_1___default.a.replace();
};
var attachDismissableBanners = function attachDismissableBanners() {
  var controls = document.querySelectorAll("[data-dismiss-banner]");
  controls.forEach(function (control) {
    control.addEventListener("click", function (e) {
      var banner = control.closest(".banner");
      dismissBanner(control);
...
var dismissBanner = function dismissBanner(control) {
  var banner = control.closest(".banner");
  banner.style.height = "".concat(banner.offsetHeight, "px");
  banner.classList.add("banner-exiting");
  setTimeout(function () {
    banner.style.height = "0px";
  }, 50);
};
var assignActiveLinks = function assignActiveLinks(newUrl) {
  var activeLinks = document.querySelectorAll("a.active");
  activeLinks.forEach(function (link) {
    link.classList.remove("active");
  });
  var links = document.querySelectorAll("nav a");
  var activeTarget = document.querySelector("[data-active-links]") ? document.querySelector("[data-active-links]").getAttribute("data-active-links") : "zzzzzzz";
...
var attachSmoothScroll = function attachSmoothScroll() {
  var scroll = new smooth_scroll__WEBPACK_IMPORTED_MODULE_0___default.a("[smooth-scroll]", {
    speed: 400,
    offset: function offset(a, b) {
      var paddingTop = parseInt(window.getComputedStyle(a, null).getPropertyValue("padding-top").replace("px", ""), 10);
      return paddingTop;
    }
  });
};
...
/***/ "../../Sites/octopus/src/js/utils/DropdownMenu.js":
/*!*********************************************************************!*\
  !*** /Users/jasonpolito/Sites/octopus/src/js/utils/DropdownMenu.js ***!
  \*********************************************************************/
/*! exports provided: makeNav */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeNav", function() { return makeNav; });
var _this = undefined;
...
var makeNav = function makeNav() {
  ...
  Strut.isRetina = window.devicePixelRatio > 1.3, Strut.mobileViewportWidth = 670, Strut.isMobileViewport = window.innerWidth < Strut.mobileViewportWidth, window.addEventListener("resize", function () {
    ...
    document.querySelector(".dropdownRoot").style.top = document.querySelector("header").offsetHeight - 12 + "px"; // new globalNavPopup(".globalNav .navSection.mobile"),
...
/***/ "../../Sites/octopus/src/js/utils/SetupPage.js":
/*!******************************************************************!*\
  !*** /Users/jasonpolito/Sites/octopus/src/js/utils/SetupPage.js ***!
  \******************************************************************/
...
/* harmony import */ var _Users_jasonpolito_Sites_octopus_src_js_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! /Users/jasonpolito/Sites/octopus/src/js/utils */ "../../Sites/octopus/src/js/utils.js");
/* harmony import */ var _Users_jasonpolito_Sites_octopus_src_js_utils_DropdownMenu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! /Users/jasonpolito/Sites/octopus/src/js/utils/DropdownMenu */ "../../Sites/octopus/src/js/utils/DropdownMenu.js");



var SetupPage = function SetupPage(newUrl) {
  var header = document.querySelector("header");
  header.classList = "";

  if (document.querySelector("[data-header-classes]")) {
    var headerClasses = document.querySelector("[data-header-classes]").getAttribute("data-header-classes");
  ...
  Object(_Users_jasonpolito_Sites_octopus_src_js_utils__WEBPACK_IMPORTED_MODULE_1__["assignActiveLinks"])(newUrl);
  Object(_Users_jasonpolito_Sites_octopus_src_js_utils__WEBPACK_IMPORTED_MODULE_1__["attachSmoothScroll"])();
  Object(_Users_jasonpolito_Sites_octopus_src_js_utils_DropdownMenu__WEBPACK_IMPORTED_MODULE_2__["makeNav"])();
  Object(_Users_jasonpolito_Sites_octopus_src_js_utils__WEBPACK_IMPORTED_MODULE_1__["attachDismissableBanners"])();
  Object(_Users_jasonpolito_Sites_octopus_src_js_utils__WEBPACK_IMPORTED_MODULE_1__["generateIcons"])();
  var imgs = document.querySelectorAll(".lazyload[data-focus-left]");
  Object(_Users_jasonpolito_Sites_octopus_src_js_utils__WEBPACK_IMPORTED_MODULE_1__["responsifyImages"])(imgs);
  window.addEventListener("resize", function () {
    Object(_Users_jasonpolito_Sites_octopus_src_js_utils__WEBPACK_IMPORTED_MODULE_1__["responsifyImages"])(imgs);
  });
  Object(_Users_jasonpolito_Sites_octopus_src_js_utils__WEBPACK_IMPORTED_MODULE_1__["lazyLoadImages"])();
...
/***/ "../../Sites/octopus/src/js/utils/responsify.js":
/*!*******************************************************************!*\
  !*** /Users/jasonpolito/Sites/octopus/src/js/utils/responsify.js ***!
  \*******************************************************************/
/*! exports provided: responsify */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "responsify", function() { return responsify; });
var calculatePosition = function calculatePosition(img) {
  var owidth, oheight, twidth, theight, fx1, fy1, fx2, fy2, width, height, top, left, ratio;
  owidth = img.offsetWidth;
  ratio = img.getAttribute("data-ratio") ? Number(img.getAttribute("data-ratio")) : false;
  oheight = ratio ? owidth * ratio : img.offsetHeight;

  if (!ratio) {
    img.setAttribute("data-ratio", oheight / owidth);
  }

  ratio = ratio ? ratio : oheight / owidth;
  twidth = img.parentElement.offsetWidth;
  theight = img.parentElement.offsetHeight;
  fx1 = Number(img.getAttribute("data-focus-left"));
  fy1 = Number(img.getAttribute("data-focus-top"));
  fx2 = Number(img.getAttribute("data-focus-right"));
  fy2 = Number(img.getAttribute("data-focus-bottom"));
  ...
  if (owidth / oheight > twidth / theight) {
    ...
    if (fwidth / oheight > twidth / theight) {
      ...
      left = twidth / 2 - (fx1 + fx2) * width / 2; // if left > 0, it will leave blank on the left, so set it to 0;

      left = left > 0 ? 0 : left; // if width - left < twidth, it will leave blank on the right, so set left = width - twidth
    ...
    if (fheight / owidth > theight / twidth) {
      ...
      top = theight / 2 - (fy1 + fy2) * height / 2; // if top > 0, it will leave blank on the top, so set it to 0;

      top = top > 0 ? 0 : top; // if height - top < theight, it will leave blank on the bottom, so set top = height - theight
  ...
  img.style.height = "".concat(width * ratio, "px");
  img.style.width = "".concat(width, "px");
  img.style.left = "".concat(left, "px");
  img.style.top = "".concat(top, "px");
};

var responsify = function responsify(imgs) {
  imgs.forEach(function (img) {
    calculatePosition(img);
...
/***/ "../../Sites/octopus/src/sass/theme.scss":
/*!************************************************************!*\
  !*** /Users/jasonpolito/Sites/octopus/src/sass/theme.scss ***!
  \************************************************************/
...
module.exports = __webpack_require__(/*! ../lib/plugins/container */ "./node_modules/tailwindcss/lib/plugins/container.js")
...
var buildUnits = function buildUnits(num) {
  var res = {};

  for (var i = 0; i < num; i++) {
    res[i * 2] = "".concat(0.5 * i, "rem");
  }

  return res;
};

var applyHue = function applyHue(color, targetColor) {
  var amount = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.5;
  var hue = tinycolor(targetColor).toHsl().h;

  var _tinycolor$toHsl = tinycolor(color).toHsl(),
...
var colors = {
  // 'primary': '#338591',
  black: "mix(black, desaturate(@color-primary, 60%), 60%)",
  primary: "@color-primary",
  "primary-light": "mix(#fff, @color-primary, 30%)",
  "primary-lighter": "mix(#fff, @color-primary, 60%)",
  "primary-lightest": "mix(#fff, @color-primary, 80%)",
  "primary-dark": "mix(#000, @color-primary, 15%)",
  "primary-darker": "mix(#000, @color-primary, 30%)",
  "primary-darkest": "mix(#000, @color-primary, 45%)",
  accent: "@color-accent",
  "accent-light": "mix(#fff, @color-accent, 30%)",
  "accent-lighter": "mix(#fff, @color-accent, 60%)",
  "accent-lightest": "mix(#fff, @color-accent, 80%)",
  "accent-dark": "mix(#000, @color-accent, 20%)",
  "accent-darker": "mix(#000, @color-accent, 33%)",
  "accent-darkest": "mix(#000, @color-accent, 45%)",
  inherit: "inherit",
  transparent: "transparent",
  "grey-darkest": "desaturate(shade(mix(@color-primary, #616161, 20%), 20%), 25%)",
  "grey-darker": "desaturate(shade(mix(@color-primary, #757575, 20%), 10%), 25%)",
  "grey-dark": "desaturate(shade(mix(@color-primary, #9e9e9e, 20%), 5%), 25%)",
  grey: "desaturate(mix(@color-primary, #bdbdbd, 20%), 25%)",
  "grey-light": "desaturate(tint(mix(@color-primary, #e0e0e0, 20%), 20%), 25%)",
  "grey-lighter": "desaturate(tint(mix(@color-primary, #eeeeee, 20%), 40%), 25%)",
  "grey-lightest": "desaturate(tint(mix(@color-primary, #f5f5f5, 20%), 80%), 25%)",
  white: "#ffffff"
};
module.exports = {
  /*
  ...
  */
  shadows: {
    ...
    lg: "0 5px 15px 0 rgba(0,0,0,0.06)",
  ...
  */
  ...
  |
  */
  plugins: [__webpack_require__(/*! tailwindcss/plugins/container */ "./node_modules/tailwindcss/plugins/container.js")({
    center: true,
    padding: "2rem"
  })],
...
/***/ 0:
/*!*****************************************************************************************************************!*\
  !*** multi /Users/jasonpolito/Sites/octopus/src/js/app.js /Users/jasonpolito/Sites/octopus/src/sass/theme.scss ***!
  \*****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/jasonpolito/Sites/octopus/src/js/app.js */"../../Sites/octopus/src/js/app.js");
module.exports = __webpack_require__(/*! /Users/jasonpolito/Sites/octopus/src/sass/theme.scss */"../../Sites/octopus/src/sass/theme.scss");
