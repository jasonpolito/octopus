...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_SetupPage__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_barba_js__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__tailwind_config__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__tailwind_config___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__tailwind_config__);
...
var sizes = {};
var screenKeys = Object.keys(__WEBPACK_IMPORTED_MODULE_4__tailwind_config__["screens"]);
var keyLength = screenKeys.length;
for (var screen in __WEBPACK_IMPORTED_MODULE_4__tailwind_config__["screens"]) {
  var width = __WEBPACK_IMPORTED_MODULE_4__tailwind_config__["screens"][screen];
  var index = screenKeys.indexOf(screen);
  var nextWidth = index == keyLength - 1 ? false : __WEBPACK_IMPORTED_MODULE_4__tailwind_config__["screens"][screenKeys[index + 1]];
...
Object(__WEBPACK_IMPORTED_MODULE_2__utils_SetupPage__["a" /* SetupPage */])();

var HideShowTransition = __WEBPACK_IMPORTED_MODULE_3_barba_js___default.a.BaseTransition.extend({
...
__WEBPACK_IMPORTED_MODULE_3_barba_js___default.a.Pjax.getTransition = function () {
  return HideShowTransition;
};

__WEBPACK_IMPORTED_MODULE_3_barba_js___default.a.Pjax.start();
...
__WEBPACK_IMPORTED_MODULE_3_barba_js___default.a.Dispatcher.on('transitionCompleted', function (currentStatus, oldStatus, container) {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_2__utils_SetupPage__["a" /* SetupPage */])(currentStatus.url);
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_smooth_scroll__ = __webpack_require__(6);
...
var SetupPage = function SetupPage(newUrl) {
    Object(__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* assignActiveLinks */])(newUrl);
    Object(__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* generateIcons */])();
    Object(__WEBPACK_IMPORTED_MODULE_1__utils__["c" /* lazyLoadImages */])();
    var scroll = new __WEBPACK_IMPORTED_MODULE_0_smooth_scroll___default.a('a[href*="#"]', {
        speed: 300,
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return generateIcons; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return assignActiveLinks; });
/* unused harmony export attachSmoothScroll */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return lazyLoadImages; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_slideout__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_feather_icons__ = __webpack_require__(11);
...
var attachSmoothScroll = function attachSmoothScroll() {
    var scrollToBtns = document.querySelectorAll('[smooth-scroll]');
...
var applyHue = function applyHue(color, targetColor) {
  ...
  s = s * amount;
  return tinycolor({ h: hue, s: s, l: l }).toHexString();
};
...
var colors = {
  ...
  'accent-dark': 'mix(#000, @color-accent, 15%)',
  'accent-darker': 'mix(#000, @color-accent, 30%)',
...
module.exports = {
  ...
  */
  ...
  plugins: [__webpack_require__(15)({
    center: true,
    padding: '2rem'
  })],
